  ...
  return (
    <section className='authSection'>
      ...
      <div className='authContainer2'> 
        {!isSignUp && <img src={icon} alternate='stackOverflow' className='loginLogo' />}
        <form onSubmit={handleSubmit}>
          ...
          <button type='submit' id='authButton'>{isSignUp?'Sign up':'Log in'}</button>
