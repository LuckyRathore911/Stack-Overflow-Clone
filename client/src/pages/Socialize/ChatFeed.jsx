...
const ChatFeed = (props) => {                               // console.log(props)
  ...
  const chat = chats && chats[activeChat];                  // console.log(chat, userName, messages);
  ...
  const renderMessages =()=>{
    ...
    const keys = Object.keys(messages)                                      // console.log(keys)
    
    return keys.map((key,index) =>{
      const message =messages[key]                                          //to iterate over each message
