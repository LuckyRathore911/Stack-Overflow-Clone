            ...
            <form onSubmit={handleSubmit}> 
                <div className='ask-form-container'>
                    ...
                    <label htmlFor='ask-ques-body'>
                        ...
                        <textarea onChange={e=>{setQuestionBody(e.target.value)}} id='ask-ques-body' cols='30' rows='10' onKeyPress={handleEnter}></textarea>
                    </label>
                ...
                <input type='submit' value='Post Your Question' className='review-btn'></input>
            </form>
        </div>
    </div>
  )
